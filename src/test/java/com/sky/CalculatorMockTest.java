...
public class CalculatorMockTest {
	...
	public void setUp() throws Exception {
		...
		when(calc.divide(-100, 0.00)).thenThrow(DivisionByZeroException.class);
	}
	...
	public void divisionByZeroThrowsException(){
		Account acc= new Account(100, calc);
		DivisionByZeroException e = Assertions.assertThrows(DivisionByZeroException.class, ()->{
			acc.getInterest(-100, 0.00);
		});
	}
